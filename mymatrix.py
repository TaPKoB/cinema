...
Original file is located at
    https://colab.research.google.com/drive/1S26WM6e9MIg5TKSdyZPKyxLqjJdol7Sv
"""
...
# должно работать не только
# matrix + some_list, matrix * 5
# но и some_list + matrix, 5 * matrix